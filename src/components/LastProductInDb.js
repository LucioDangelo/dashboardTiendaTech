...
function LastProductInDb(){
    ...
    useEffect(() => {
         ...
         fetch("https://grupo-8-digital-tech.herokuapp.com/api/products/lastproduct")
                ...
                {lastProduct.length !== 0 && 
                    <div className="card-body">
                        <div className="text-center">
                            <img className="img-fluid px-2 px-sm-2 mt-2 mb-4" style={{width: 18 +'rem'}} src={`https://grupo-8-digital-tech.herokuapp.com/img/${lastProductImage}`} alt="Last Product in Data Base"/>
                        </div>
                        <h3>
                            {lastProduct[0].title}
                        </h3>
